...
#### 最终效果
##### 任务增加
![scheduler_job_add_configuration](../../image/scheduler_job_add_configuration.png)
![scheduler_job_add_schedule](../../image/scheduler_job_add_schedule.png)
##### 任务详情
![scheduler_job_detail](../../image/scheduler_job_detail.png)

##### 任务验证
![scheduler_job_update_attributes](../../image/scheduler_job_update_attributes.png)
